...
library(foreign)
library(psych)
library(lavaan)  # for CFA, use version 0.5-23.1097
library(semTools)  # for reliability, use version 0.4-14
library(semPlot)  # for path diagram, use version 1.0.1
...
standardizedSolution(cfa.model)  # standardized, to view the 95% CI
varTable(cfa.model)  # mean and variance for each item from the cfa model
