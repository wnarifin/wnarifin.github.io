---
title: "Covid-19 for Malaysia Dashboard"
output: 
...
# saved_cfg = data.world::save_config("eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJwcm9kLXVzZXItY2xpZW50OnduYXJpZmluIiwiaXNzIjoiYWdlbnQ6d25hcmlmaW46OjljOTExNmE1LWNkMzQtNGY2Zi05YjFlLTdhNWZmNDZiNjFhMCIsImlhdCI6MTU4NDg2Njc0Mywicm9sZSI6WyJ1c2VyX2FwaV9yZWFkIiwidXNlcl9hcGlfd3JpdGUiXSwiZ2VuZXJhbC1wdXJwb3NlIjp0cnVlLCJzYW1sIjp7fX0.vss7gFvq2VyS-vx__DOfJnJH6uIwQ2YaptnfQ1PEkRi7knxQVZhJW2zZQ4UGlmFThI6JZQx2nmLkYjsBQGZyWg")
# data.world::set_config(saved_cfg)
# covid_my_ = "https://data.world/wnarifin/covid-19-my/"
# covid_my_query = data.world::qry_sql(paste0(
#   "SELECT *",
#   "FROM covid_19_my"))
# 
# covid_my = data.world::query(covid_my_query, covid_my_)
# covid_my = as.data.frame(covid_my[order(covid_my$date),])
covid_my = read.csv("covid-19_my.csv")
covid_my$date = as.Date(covid_my$date)

sel_location = "Malaysia"
sel_date = Sys.Date()

# uda holdings event, not modeled yet
# covid_my$uda = 0
# covid_my[covid_my$date >= "2020-03-02", "uda"] = 1
# covid_my$days_uda = cumsum(covid_my$uda)
# tabligh event
covid_my$event = 0
